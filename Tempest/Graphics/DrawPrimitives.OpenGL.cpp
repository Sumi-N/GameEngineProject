...
void DrawPrimitive::DebugInit()
{
#ifdef _DEBUG
#endif // _DEBUG
}

void DrawPrimitive::DebugDraw()
{
#ifdef _DEBUG
...
void DrawPrimitive::DrawLineWithShader(Vec3f start_point, Vec3f end_point)
{
	GLfloat linevertex[] =
	{
