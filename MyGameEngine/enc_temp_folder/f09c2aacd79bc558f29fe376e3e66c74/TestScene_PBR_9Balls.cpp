...
void TestScene::PBR_9Balls()
{
	...
	rastered->axis1 = Vec3f((rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2);
	gold->axis1 = Vec3f((rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2);
	cement->axis1 = Vec3f((rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2);
	metalgrid->axis1 = Vec3f((rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2);
	bathroomtile->axis1 = Vec3f((rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2);
	dirtyweave->axis1 = Vec3f((rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2);
	graybrick->axis1 = Vec3f((rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2);
	brushedmetal->axis1 = Vec3f((rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2);
	oldsoiledcloth->axis1 = Vec3f((rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2, (rand() % 100 / 100 - 50) * 2);
