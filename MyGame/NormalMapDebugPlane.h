...
namespace Tempest
{
	...
	inline void NormalMapDebugPlane::Boot()
	{
		...
		quadtexture->Load(PATH_SUFFIX BIN_TEXTURE_PATH "albedo/gray.tt", TextureType::PB_Diffuse);
		quadtexture2->Load(PATH_SUFFIX BIN_TEXTURE_PATH "albedo/gray.tt", TextureType::PB_Specular);
		quadtexture3->Load(PATH_SUFFIX BIN_TEXTURE_PATH "normal/teapot_normal.tt", TextureType::PB_Normal);
		quadtexture4->Load(PATH_SUFFIX BIN_TEXTURE_PATH "displacement/teapot_disp.tt", TextureType::PB_Displacement);
